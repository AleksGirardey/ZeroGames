        ...
        public void CalculVitesseMoyenne() {
            ...
            if (distance <= (vitesseAccelerationMoy * tempsAcceleration) + (vitesseEnduMoy * tempsEndurance)) {
                ...
                VitesseMoyenne =
                    ...
                    (tempsAcceleration
                     + tempsEndurance
                     + ((distance - (vitesseAccelerationMoy * tempsAcceleration) - (vitesseEnduMoy * tempsEndurance)) *
                        (VitesseMax * EndurancePourc)));
            }
